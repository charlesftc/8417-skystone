...
public class BlueAuto1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (skystonePos == 0) {
            ...
            a.pidDrive(1.5, 23, 86, 0.3, 2, 1.5, true, false);
            a.intake(0, 0.35, 0, 1, 1.3, false);
            a.velDrive(0, -0.2, -0.8, 0.3, false);
        } else {
            a.pidDrive(10, 23, 86, 0.3, 2, 1.8, true, false);
            a.intake(0, 0.35, 0, 1, 1.3, false);
            a.velDrive(0, -0.2, -0.8, 0.3, false);
        }
        ...
        a.pidDrive(-80, 21, -90, 0.3, 2.5, 2, true, false);
        ...
        a.setHookPos(a.hookPos[0]);
        a.velDrive(0, 0.2, 1, 0.8, false);
        a.pidDrive(-16, 20, 0, 3, 4, 1.5, false, false);
        a.beltBar.setPos(a.beltBar.pos[0]);
        ...
        a.pidDrive(-58, 22, 16, 1, 2, 2.4, false, false);

        a.autoStacker.level = 2;
        a.autoStacker.createThread(AutoStacker.Task.PLACE_STONE);
        a.velDrive(0.35, -0.5, 0, 0.5, true);
        a.setIntakePow(-0.5);
        sleep(1600);
        a.setIntakePow(0);
        //a.velDrive(0, 1, 0, 0.6, false);
        a.pidDrive(-58, 22, 0, 3, 2, 1, false, false);

        if (skystonePos == 0) {
            a.pidDrive(-14, 26, 40, 0.3, 2, 1.5, true, false);
            a.beltBar.setPos(a.beltBar.pos[0]);
            a.intake(0.1, 0.4, 0, 1, 1, false);
            //a.velDrive(0, -0.9, -0.2, 0.2, false);
        } else if (skystonePos == 1) {
            a.pidDrive(-16, 25, 60, 0.3, 2, 2, true, false);
            a.beltBar.setPos(a.beltBar.pos[0]);
            a.intake(0, 0.4, 0, 1, 1, false);
            a.velDrive(0, -0.2, -0.8, 0.3, false);
        } else {
            a.pidDrive(-19, 26, 50, 0.3, 2, 1.5, true, false);
            a.beltBar.setPos(a.beltBar.pos[0]);
            a.intake(-0.1, 0.4, 0, 1, 1, false);
            a.velDrive(0, -0.6, -0.2, 0.15, false);
        }

        a.pidDrive(-56, 22, 14, 1, 2, 1.5, false,false);
