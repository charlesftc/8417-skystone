...
public class TwoStoneQuarryAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        autoController.pidDrive(-6.5, 22, 0.795, 0.25, 0.15, 2);

        autoController.intakeStone(0, 0.5, 0, 1, 2);
        autoController.drive(0, -0.5, 0, 0.2, false);
        ...
        autoController.drive(0, -0.4, 0, 2.5, false);//-0.8
        autoController.setHookPos(0);
        ...
        autoController.intakeStone(0, 0.5, 0, 1, 2);
        autoController.drive(0, -0.5, 0, 0.3, false);
        autoController.pidDrive(-18, 22, Math.PI, 0.2, 0.1, 3);
        autoController.setIntakeLiftPos(0.52);
        ...
        autoController.pidDrive(-19, 23, Math.PI, 1, 1, 30);
