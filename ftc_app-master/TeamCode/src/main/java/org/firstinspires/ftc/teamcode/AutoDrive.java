...
public class AutoDrive extends LinearOpMode {
    ...
    private double kP = 0.55; //0.3 worked well but slow
    private double thetaKP = 0.6;

    private double xErrorSum = 0;
    private double yErrorSum = 0;
    private double tErrorSum = 0;
    private double maxErrorSum = 0.5;
    private double maxTErrorSum = 0.2;
    private double kI = 0.007; //0.005
    private double thetaKI = 0.0015; //0.002

    private double brakingDist = 6; //was 4
    private double turnBrakingDist = 0.2; //OLD: 1

    private double velThreshold = 0.3;
    private double turnVelThreshold = 0.1;
